...
class TestRipgrepParsing:
    ...
    def test_parse_json_one_match(self):
        ...
        stdout = (
            ...
            + "\n"
            + self._make_json_line("match", path={"text": "/a.py"}, line_number=5,
                                   absolute_offset=0, column=1, absolute_column=1,
    ...
    def test_parse_json_multi_match(self):
        ...
        stdout = "\n".join([
            ...
            self._make_json_line("match", path={"text": "/a.py"}, line_number=3,
                                 absolute_offset=0, column=1, absolute_column=1,
                                 lines={"text": "import os\n"}),
            self._make_json_line("match", path={"text": "/a.py"}, line_number=7,
                                 absolute_offset=20, column=1, absolute_column=1,
