...
from codeanalyze.analyzers import ripgrep
from codeanalyze.commands.common import console
...
def search(pattern: str, path: str, regex: bool, fixed: bool, ignore_case: bool,
           glob: str | None, file_type: str | None, context: int,
           max: int, json_flag: bool):
