...
from codeanalyze.analyzers import codereviewgraph
...
def crg_viz(path: str, output: str | None):
    """生成交互式 HTML 图谱可视化。"""
    root = _validate_path(path)
