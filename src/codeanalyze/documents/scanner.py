...
_CODE_EXTENSIONS = {".py", ".ts", ".tsx", ".js", ".jsx", ".go", ".rs", ".java",
...
def analyze_wiki_structure(root_path: str) -> dict:
    ...
    required_files = [
        "MEMORY.md", "STATE.md", "ENTITIES.md", "TIMELINE.md", "INDEX.md"
    ]
    meta_files = [
        "KnowledgeProtocol.md", "frontmatter规范.md",
        "信源监测矩阵.md", "状态机.md", "维护手册.md"
    ]
