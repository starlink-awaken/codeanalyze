...
class WorkspaceInfo:
    ...
    name: str
    has_git: bool = False
    language_guesses: list[str] = None
    total_files: int = 0
    code_files: int = 0
    doc_files: int = 0
...
_EXT_CODE = {".py", ".ts", ".tsx", ".js", ".jsx", ".go", ".rs", ".java",
             ".c", ".cpp", ".h", ".hpp", ".rb", ".cs", ".kt", ".scala",
             ".php", ".swift", ".lua", ".mjs", ".vue", ".svelte", ".astro",
             ".zig", ".ex", ".exs", ".jl", ".dart", ".v", ".sh", ".bash"}
_EXT_DOC = {".md", ".mdx", ".html", ".pdf", ".docx", ".xlsx", ".pptx",
             ".txt", ".rst", ".yaml", ".yml", ".json", ".csv"}
