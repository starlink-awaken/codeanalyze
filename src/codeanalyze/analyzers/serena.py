...
def get_available_tools() -> list[str]:
    ...
    return [
        ...
        "find_declaration", "get_symbols_overview", "get_diagnostics_for_file",
        "get_diagnostics_for_symbol", "rename_symbol", "replace_symbol_body",
        "safe_delete_symbol", "search_for_pattern", "query_project",
    ]
